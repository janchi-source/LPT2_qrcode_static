...
// Poradie POĽA = fyzický kruh po areáli. Rotácia ide po tomto poradí, takže
// index v poli je zároveň poloha na kruhu — na tom stojí celý výpočet trás.
// Písmená sú menovky aktivít z manuálu (s. 2–3) a po oprave rozpisu (C k Panne
// Márii je PRED mantinelami) idú po abecede rovnako ako kruh.
const STANOVISTIA = [
  ...
  { i: 2, letter: 'C', nazov: 'Duangango', miesto: 'pri Panne Márii', material: '—' },
  { i: 3, letter: 'D', nazov: 'Toaleťák', miesto: 'mantinely', material: 'toaleťák' },
